      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          ...
          contenidos =
            ...
            '<h4 id="nombre_empresa" style="margin: 0">' +
            datos.result.data[i].nombre +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>RFC</label><br>" +
            '<h4 id="rfc" style="margin: 0">' +
            ...
            '<h4 style="margin: 0">$' +
            datos.result.data[i].monto_remuneracion +
            "</h4><br>" +
            "</div>" +
            "</div><hr>" +
            '<div class="form-group"> ' +
      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          ...
          contenidos =
            ...
            '<h4 style="margin: 0">' +
            datos.result.data[i].tipo_institucion +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-3">' +
            ...
            '<h4 style="margin: 0">' +
            datos.result.data[i].fecha_inicio_part +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>Recibe remuneración</label><br>" +
      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          contenidos =
            ...
            '<h4 style="margin: 0">' +
            datos.result.data[i].forma_beneficio +
            "</h4><br>" +
            "</div>" +
            "</div><hr>" +
            '<div class="form-group">' +
          ...
          if (datos.result.data[i].forma_beneficio == "MONETARIO") {
            contenidos =
              ...
              "<label>Monto mensual</label><br>" +
              '<h4 style="margin: 0">$' +
              datos.result.data[i].monto_beneficio +
              "</h4><br>" +
              "</div>";
          } else {
            contenidos =
              ...
              '<h4 style="margin: 0">' +
              datos.result.data[i].especifica_beneficio +
              "</h4><br>" +
              "</div>";
          }
      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          ...
          contenidos =
            ...
            '<div class="col-md-3">' +
            "<label>Fecha de inicio</label><br>" +
            '<h4 id="fecha_inicio" style="margin: 0">' +
      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          ...
          contenidos =
            ...
            '<h4 style="margin: 0">$' +
            datos.result.data[i].ganancia_por_cte_principal +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-4">' +
            "<label>Pais</label><br>" +
            '<h4 style="margin: 0">' +
            datos.result.data[i].pais_domicilio_extranjero +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>Sector/Industria</label><br>" +
      ...
      if (datos.status) {
        ...
        for (var i = 0; i < Object.keys(datos.result.data).length; i++) {
          ...
          contenidos =
            ...
            '<div class="col-md-4">' +
            "<label>Nombre o razón social</label><br>" +
            '<h4 id="fiduciario" style="margin: 0">' +
            datos.result.data[i].nombre_fideicomisario +
            "</h4>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>RFC Fideicomisario</label><br>" +
            '<h4 style="margin: 0">' +
            datos.result.data[i].rfc_fideicomisario +
            "</h4>" +
            "</div>" +
            "</div><hr>" +
            '<div class="form-group"> ' +
            ...
            "<label>Nombre o razón social</label><br>" +
            '<h4  style="margin: 0">' +
            datos.result.data[i].nombre_fideicomitente +
            "</h4>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>RFC Fideicomitente</label><br>" +
            '<h4 style="margin: 0">' +
            datos.result.data[i].rfc_fideicomitente +
            "</h4>" +
            "</div>" +
            "</div><hr>" +
            '<div class="form-group"> ' +
            ...
            "<label>Nombre o razón social</label><br>" +
            '<h4 style="margin: 0">' +
            datos.result.data[i].nombre_fidiuciario +
            "</h4>" +
            "</div>" +
            '<div class="col-md-3">' +
            "<label>RFC Fiduciario</label><br>" +
            '<h4 id="rfc_fideicomitente" style="margin: 0">' +
            datos.result.data[i].rfc_fidiuciario +
            "</h4>" +
            "</div>" +
            "</div><hr>" +
            '<div class="form-group">' +
            ...
            "<label>País</label><br>" +
            '<h4 style="margin: 0">' +
            datos.result.data[i].pais_fideicomiso +
            "</h4><br>" +
            "</div>" +
            '<div class="col-md-4">' +
            "<label>Sector / Industria</label><br>" +
