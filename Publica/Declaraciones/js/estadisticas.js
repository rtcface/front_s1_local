...
function graficaEstudioEdad(){
    ...
    $.ajax({
        ...
        var educacion=['Primaria','Secundaria','Bachillerato', 'Carrera técnica','Licenciatura', 'Especialidad','Maestria','Doctorado'];
...
function graficaBarraSimpleEdades(objeto,label){
    ...
    for(i=0;i<Object.keys(objeto.result.data).length;i++){
        ...
        if(objeto.result.data[i].column_title>=18 && objeto.result.data[i].column_title<=27){
            edades[0]=edades[0]+objeto.result.data[i].data_result;
        }else if(objeto.result.data[i].column_title>=28 && objeto.result.data[i].column_title<=37){
            edades[1]=edades[1]+objeto.result.data[i].data_result;
        }else if(objeto.result.data[i].column_title>=38 && objeto.result.data[i].column_title<=47){
            edades[2]=edades[2]+objeto.result.data[i].data_result;
        }else if(objeto.result.data[i].column_title>=48 && objeto.result.data[i].column_title<=57){
            edades[3]=edades[3]+objeto.result.data[i].data_result;
        }else if(objeto.result.data[i].column_title>=58 && objeto.result.data[i].column_title<=67){
...
function graficaBarraSimple2(objeto,label){
    ...
    var total=0;
    var i;
    var titulo=['0-$100,000','$100,000-$300,000','$300,000-$500,000','$500,000 o más'];

    for(i=0;i<Object.keys(objeto.result.data).length;i++){
        if(objeto.result.data[i].ingreso_total>=0 && objeto.result.data[i].ingreso_total<100000){
            totales[0]=totales[0]+1;
        }else if(objeto.result.data[i].ingreso_total>=100000 && objeto.result.data[i].ingreso_total<300000){
            totales[1]=totales[1]+1;
        }else if(objeto.result.data[i].ingreso_total>=300000 && objeto.result.data[i].ingreso_total<500000){
    ...
    for(i=0;i<Object.keys(objeto.result.data).length;i++){
        switch(objeto.result.data[i].level){
            case 'ESTATAL':
                ...
                cantEstatal[index]=cantEstatal[index]+objeto.result.data[i].data_result;
            break;
            case 'MUNICIPAL_ALCALDIA':
                index=verificarEdad(objeto.result.data[i].column_title);
                cantMunicipal[index]=cantMunicipal[index]+objeto.result.data[i].data_result;
            break;
        }
    }
    myChart.clear();
