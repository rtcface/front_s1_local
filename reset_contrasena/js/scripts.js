...
function buscar() {
  $.ajax({
    ...
    .done(function (datos) {
      if (datos.status) {
        var tabla =
          "<tr><th>Nombre </th><th>Ente Público</th><th>Cargo Actual</th><th></th></tr>";
        tabla =
          tabla +
          "<tr><td>" +
          datos.result.data["nombres"] +
          " " +
          ...
          "</td><td>" +
          "<button type='button' class='botonEnviar' onclick='resetContModal(" +
          datos.result.data["id"] +
          ")'>Resetear contraseña</button></tr>";
