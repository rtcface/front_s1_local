function selectDatosGenerales(){
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclarante?id_declarante='+id_declarante+'&tipo_declaracion=' + tipoDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('primerApellido').value=datos.result.data.apellido_paterno;
                document.getElementById('segundoApellido').value=datos.result.data.apellido_materno;
                document.getElementById('curp').value=datos.result.data.curp;
                document.getElementById('rfc').value=datos.result.data.rfc;
                document.getElementById('homoclave').value=datos.result.data.rfc_homoclave;
                document.getElementById('emailInstituto').value=datos.result.data.correo_electronico_lab;
                document.getElementById('emailPersonal').value=datos.result.data.correo_electronico_per;
                document.getElementById('telParticular').value=datos.result.data.tel_per;
                ...
                if(datos.result.data.estado_civil=='CASADO (A)'){
                    $('#regimen').show();
                    if(datos.result.data.regimen_matrimonial != 'SOCIEDAD CONYUGAL' && datos.result.data.regimen_matrimonial != 'SEPARACION DE BIENES'){
                        $('#otroRegimen').show();
                        document.getElementById('regimenM').value='OTRO';
                        document.getElementById('otroRegimen').value=datos.result.data.regimen_matrimonial;
                    }else{
                        document.getElementById('regimenM').value=datos.result.data.regimen_matrimonial;
                        $('#otroRegimen').hide();
                    }
                }else{
                    $('#regimen').hide();
                ...
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
...
function selectDomicilio(){
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteDomicilioByID?tipo_declaracion=' + tipoDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                if(datos.result.data.pais_domicilio== '146'){
                    ...
                    document.getElementById('nombreVia').value=datos.result.data.nombre_via_domicilio;
                    ...
                    document.getElementById('nombreViaExt').value=datos.result.data.nombre_via_domicilio;
                    ...
                    document.getElementById('entidadExt').value=datos.result.data.estado_domicilio_extranjero;
...
function selectDatosCurriculo(){
    ...
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteCurriculoByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('institucionEducativa').value=datos.result.data.institucion_educativa;
                document.getElementById('carrera').value=datos.result.data.especialidad;
                if(datos.result.data.nivel_curricular != 'PRIMARIA' && datos.result.data.nivel_curricular != 'SECUNDARIA' && datos.result.data.nivel_curricular != 'BACHILLERATO'){
                    $('#contCarrera').show();
                ...
                $("#finalizado").datepicker( "setDate" , new Date(datos.result.data.fecha_obtencion_doc.split("/").reverse().join("/")));
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
                $('#formCompleto').show();
            } else{
                alert(datos.msg);
...
function selectEmpleo(){
    ...
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteEncargoActualByID?tipo_declaracion='+tipoDeclaracion+'&id_declarador=&id=',
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('entePublico').value=datos.result.data.ente_publico;
...
function selectEmpleoOtro(){
    ...
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteEncargoActualByID?tipo_declaracion='+tipoDeclaracion+'&id_declarador='+id_declarante+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.otro_empleo){
                    $('#formCompleto').find('input, button, select').prop('disabled',false);
                }else{
                    $('#formCompleto').find('input, button, select').prop('disabled',true);
                }
...
function selectExpLaboral(){
    ...
    $('#agregar_nuevo').attr('disabled','disabled');
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteExperienciaLaboralByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.ambito!='PRIVADO' && datos.result.data.ambito!='PUBLICO' ){
                ...
                document.getElementById('nombreEnte').value=datos.result.data.nombre_institucion;
                document.getElementById('area').value=datos.result.data.unidad_administrativa;
                document.getElementById('rfc').value=datos.result.data.rfc;
                document.getElementById('cargo').value=datos.result.data.cargo_puesto;
                document.getElementById('funciones').value=datos.result.data.funciones_principales;
                $("#fecIngreso").datepicker( "setDate" , new Date(datos.result.data.fecha_ingreso.split("/").reverse().join("/")));
                if( datos.result.data.empleo_actual ){
                    $('#trabajo_actual').attr('checked',true);
                    $('#fecSalida').attr('disabled','disabled');
                }else{
                    $("#fecSalida").datepicker( "setDate" , new Date(datos.result.data.fecha_salida.split("/").reverse().join("/")));
                ...
                if(datos.result.data.sector_industria=='sector_17' && datos.result.data.ambito!='PUBLICO'){
                    $("#"+datos.result.data.sector_industria).prop("checked", true);
                    $('#otroSector').show();
                    $('#otroSector').val(datos.result.data.otro_sector_industria);
                }else if(datos.result.data.sector_industria!='sector_17' && datos.result.data.ambito!='PUBLICO'){
                    $("#"+datos.result.data.sector_industria).prop("checked", true);
                    $('#otroSector').hide();
                }
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
...
function selectDatosParejaDependiente(pareja){
    ...
    $.ajax({
        url: ip + '/declaraciones/declarante/selectDeclaranteConyugeDepByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion+'&conyuge='+pareja,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.tipo_relacion!='CONYUGE' && datos.result.data.tipo_relacion!='CONCUBINA / CONCUBINARIO / UNION LIBRE' && datos.result.data.tipo_relacion!='SOCIEDAD DE CONVIVENCIA' 
                    && datos.result.data.tipo_relacion!='ABUELO (A)' && datos.result.data.tipo_relacion!='AHIJADO (A)' && datos.result.data.tipo_relacion!='Cuñado (A)' && datos.result.data.tipo_relacion!='HERMANO (A)' 
                    && datos.result.data.tipo_relacion!='HIJO (A)' && datos.result.data.tipo_relacion!='MADRE' && datos.result.data.tipo_relacion!='Nieto (A)' && datos.result.data.tipo_relacion!='PADRE' 
                    && datos.result.data.tipo_relacion!='PRIMO (A)' && datos.result.data.tipo_relacion!='SOBRINO (A)' && datos.result.data.tipo_relacion!='Suegro (A)' && datos.result.data.tipo_relacion!='TIO (A)' ){
                ...
                document.getElementById('segundoApellido').value=datos.result.data.apellido_materno;
                document.getElementById('rfc').value=datos.result.data.rfc;
                $("#fecNac").datepicker( "setDate" , new Date(datos.result.data.fecha_nacimiento.split("/").reverse().join("/")));
                ...
                if(datos.result.data.pais_domicilio== '146'){
                    ...
                    $('#nombreVia').prop('required',true);
                    $('#numExterior').prop('required',true);
                }else if(datos.result.data.pais_domicilio > '0' && datos.result.data.pais_domicilio!= '146'){
                    document.getElementById('lugarE').checked =true;
                    $("#nacional").hide();
                    $("#extranjero").show();
                    $("#paisE").show();
                ...
                document.getElementById('nombreEnte').value=datos.result.data.nombre_institucion;
                document.getElementById('area').value=datos.result.data.area_adscripcion;
                document.getElementById('rfcEmpresa').value=datos.result.data.rfc_empresa;
                document.getElementById('cargo').value=datos.result.data.cargo_puesto;
                document.getElementById('funciones').value=datos.result.data.funciones_principales;
                if(datos.result.data.fecha_ingreso != ""){
                    $("#fecIngreso").datepicker( "setDate" , new Date(datos.result.data.fecha_ingreso.split("/").reverse().join("/")));
                }
                document.getElementById('salario').value=datos.result.data.salario_mensual_neto;
                ...
                if(datos.result.data.sector_industria=='sector_17' && datos.result.data.actividad_laboral!='PUBLICO'){
                    $("#"+datos.result.data.sector_industria).prop("checked", true);
                    $('#otroSector').show();
                    $('#otroSector').val(datos.result.data.otro_sector_industria);
                }else if(datos.result.data.sector_industria!='sector_17' && datos.result.data.actividad_laboral!='PUBLICO'){
                    $("#"+datos.result.data.sector_industria).prop("checked", true);
                    $('#otroSector').hide();
                }
...
function selectPrestamos(){
    ...
    $.ajax({
        url: ip + '/declaraciones/pasivos/selectPasivosPrestamoComodatoByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.inmueble){
                    ...
                    if(datos.result.data.tipo_inmueble!='CASA' && datos.result.data.tipo_inmueble!='DEPARTAMENTO'  
                                && datos.result.data.tipo_inmueble!='EDIFICIO' && datos.result.data.tipo_inmueble!='LOCAL COMERCIAL'  
                                && datos.result.data.tipo_inmueble!='BODEGA' && datos.result.data.tipo_inmueble!='PALCO'   
                                && datos.result.data.tipo_inmueble!='RANCHO' && datos.result.data.tipo_inmueble!='TERRENO' ){
                    ...
                    if(datos.result.data.tipo_vehiculo!='AUTOMOVIL O MOTOCICLETA' && datos.result.data.tipo_vehiculo!='AERONAVE'  && datos.result.data.tipo_vehiculo!='BARCO O YATE' ){
                    ...
                    document.getElementById('marca').value=datos.result.data.marca_vehiculo;
                    document.getElementById('modelo').value=datos.result.data.modelo_vehiculo;
                    document.getElementById('anio').value=datos.result.data.anio_vehiculo;
                    document.getElementById('numeroSerie').value=datos.result.data.no_serie_vehiculo;
                ...
                if(datos.result.data.relacion_titular!='Conyuge' && datos.result.data.relacion_titular!='Concubina o Concubinario'  
                    && datos.result.data.relacion_titular!='ABUELO (A)' && datos.result.data.relacion_titular!='AHIJADO (A)' && datos.result.data.relacion_titular!='CUÑADO (A)' && datos.result.data.relacion_titular!='HERMANO (A)' 
                    && datos.result.data.relacion_titular!='HIJO (A)' && datos.result.data.relacion_titular!='MADRE' && datos.result.data.relacion_titular!='NIETO (A)' && datos.result.data.relacion_titular!='PADRE' 
                    && datos.result.data.relacion_titular!='PRIMO (A)' && datos.result.data.relacion_titular!='SOBRINO (A)' && datos.result.data.relacion_titular!='SUEGRO (A)' && datos.result.data.relacion_titular!='TIO (A)' ){
                ...
                document.getElementById('nombreTitular').value=datos.result.data.titular_vehiculo;
                document.getElementById('rfc').value=datos.result.data.rfc_titular_vehiculo;
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
...
function selectEmpresasSociedades(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesEmpSocByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('nombreEmpresa').value=datos.result.data.nombre;
                document.getElementById('rfc').value=datos.result.data.rfc;
                document.getElementById('porcentaje').value=datos.result.data.porcentaje_participacion;
                if(datos.result.data.tipo_participacion!='SOCIO' && datos.result.data.tipo_participacion!='ACCIONISTA' && datos.result.data.tipo_participacion!='COMISARIO'
                        && datos.result.data.tipo_participacion!='REPRESENTANTE' && datos.result.data.tipo_participacion!='APODERADO' && datos.result.data.tipo_participacion!='COLABORADOR' && datos.result.data.tipo_participacion!='BENEFICIARIO'){
                    $("#tipoParticipacion").val('OTRO');
                    document.getElementById('otraPart').value=datos.result.data.otro_tipo_participacion;
                    $("#otraPart").show();
                }else{
                ...
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
                document.getElementById('monto').value=datos.result.data.monto_remuneracion;
                $('#formCompleto').show();
            } else{
                alert(datos.msg);
                if(datos.msg=='Sesión Expirada'){
...
function selectInstituciones(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesInstitucionesByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.tipo_institucion!='OSC' && datos.result.data.tipo_institucion!='OB'
                        && datos.result.data.tipo_institucion!='PP' && datos.result.data.tipo_institucion!='GS' ){
                    $("#tipoInstitucion").val('OTRO');
                    document.getElementById('otraInst').value=datos.result.data.tipo_institucion;
                    $("#otraInst").show();
                }else{
                    $("#tipoInstitucion").val(datos.result.data.tipo_institucion);
                    $("#otraInst").hide();
                }
                document.getElementById('nombreInstitucion').value=datos.result.data.nombre_institucion;
                document.getElementById('rfc').value=datos.result.data.rfc;
                document.getElementById('puesto').value=datos.result.data.puesto_rol;
                $("#fechaInicio").datepicker( "setDate" , new Date(datos.result.data.fecha_inicio_part.split("/").reverse().join("/")));
                if(datos.result.data.recibe_remuneracion){
                    document.getElementById('remuneracionS').checked =true;
                    $('#montoRemuneracion').show();
                }else{
...
function selectApoyosBeneficios(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesBeneficiosPublicosByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.beneficiario!='DECLARANTE' && datos.result.data.beneficiario!='CONYUGE' && datos.result.data.beneficiario!='CONCUBINA O CONCUBINARIO'  
                    && datos.result.data.beneficiario!='ABUELO (A)' && datos.result.data.beneficiario!='AHIJADO (A)' && datos.result.data.beneficiario!='CUÑADO (A)' && datos.result.data.beneficiario!='HERMANO (A)' 
                    && datos.result.data.beneficiario!='HIJO (A)' && datos.result.data.beneficiario!='MADRE' && datos.result.data.beneficiario!='NIETO (A)' && datos.result.data.beneficiario!='PADRE' 
                    && datos.result.data.beneficiario!='PRIMO (A)' && datos.result.data.beneficiario!='SOBRINO (A)' && datos.result.data.beneficiario!='SUEGRO (A)' && datos.result.data.beneficiario!='TIO (A)' ){
                ...
                document.getElementById('nombrePrograma').value=datos.result.data.nombre_programa;
                document.getElementById('institucion').value=datos.result.data.nombre_otorgante;
                $("#nivelGob").val(datos.result.data.nivel)
                if(datos.result.data.tipo_beneficio!='SUBSIDIO' && datos.result.data.tipo_beneficio!='SERVICIO' && datos.result.data.tipo_beneficio!='OBRA' ){
                ...
                if(datos.result.data.forma_beneficio=='MONETARIO'){
                    ...
                    document.getElementById('espApoyo').value=datos.result.data.especifica_beneficio;
                }
                document.getElementById('monto').value=datos.result.data.monto_beneficio;
                document.getElementById('obsComentarios').value=datos.result.data.observaciones;
                $('#formCompleto').show();
            } else{
                alert(datos.msg);
...
function selectRepresentacion(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesRepresentacionActivaByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('nombreRazon').value=datos.result.data.nombre_representado;
                document.getElementById('rfc').value=datos.result.data.rfc_representado;
                $("#fechaInicio").datepicker( "setDate" , new Date(datos.result.data.fecha_inicio.split("/").reverse().join("/")));
                if(datos.result.data.recibe_remuneracion){
                    document.getElementById('remuneracionS').checked =true;
                    $('#montoRemuneracion').show();
                }else if(datos.result.data.pareja){
                ...
                document.getElementById('monto').value=datos.result.data.monto_representacion;
...
function selectClientesPrincipales(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesClientesPrincipalesByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('nombreEmpresa').value=datos.result.data.nombre_empresa;
                document.getElementById('rfc').value=datos.result.data.rfc_empresa;
                document.getElementById('nombreCliente').value=datos.result.data.nombre_cte_principal;
                document.getElementById('rfcCliente').value=datos.result.data.rfc_cte_principal;
                if(datos.result.data.id_sector_industria=='sector_17'){
                    $("#"+datos.result.data.id_sector_industria).prop("checked", true);
                    $('#otroSector').show();
                    $('#otroSector').val(datos.result.data.otro_sector_industria);
                ...
                document.getElementById('monto').value=datos.result.data.ganancia_por_cte_principal;
...
function selectBeneficiosPrivados(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesBeneficiosPrivadosByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                if(datos.result.data.tipo_beneficio!='SORTEO' && datos.result.data.tipo_beneficio!='CONCURSO' && datos.result.data.tipo_beneficio!='DONACION' ){
                    $("#otroApoyo").val(datos.result.data.tipo_beneficio);
                    $("#tipoApoyo").val('OTRO');
                    $('#otroApoyo').show();
                }else{
                ...
                document.getElementById('nombreOtorgante').value=datos.result.data.nombre_otorgante;
...
function selectFideicomisos(){
    ...
    $.ajax({
        url: ip + '/declaraciones/intereses/selectInteresesFideicomisosByID?tipo_declaracion='+tipoDeclaracion+'&id='+idDeclaracion,
        type: "GET",
        dataType: "json",
        headers: {
            'X-Auth-Token' : token
            ...
            if(datos.status){
                ...
                document.getElementById('tipoFideicomiso').value=datos.result.data.tipo_fideicomiso;
                document.getElementById('tipoParticipacion').value=datos.result.data.tipo_participacion;
                document.getElementById('rfcFideicomiso').value=datos.result.data.rfc_fideicomiso;
                document.getElementById('nombreFideicomitente').value=datos.result.data.nombre_fideicomitente;
                document.getElementById('rfcFideicomitente').value=datos.result.data.rfc_fideicomitente;
                document.getElementById('nombreFiduciario').value=datos.result.data.nombre_fidiuciario;
                document.getElementById('rfcFiduciario').value=datos.result.data.rfc_fidiuciario;
                document.getElementById('nombreFideicomisario').value=datos.result.data.nombre_fideicomisario;
                document.getElementById('rfcFideicomisario').value=datos.result.data.rfc_fideicomisario;
...
function getEnte(){
    $.ajax({
        ...
        document.getElementById('entePublico').value=datos.result.data.nombre_ente;
    }).fail( function( jqXHR, textStatus, errorThrown ) {
        alert(jqXHR.responseJSON.msg)
    });
}
