function insertarDomicilio() {
  ...
  $.ajax({
    ...
    data: JSON.stringify({
      ...
      estado_domicilio_extranjero: $("#entidadExt").val(),
...
function insertarDatosCurriculo() {
  var lugar = $("input:radio[name=lugar]:checked").val();
  ...
  $.ajax({
    ...
    data: JSON.stringify({
      ...
      observaciones: $("#obsComentarios").val(),
      fecha_obtencion_doc: document
        .getElementById("finalizado")
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById("semaforoCargo").style.color =
            "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
...
function insertarDatosParejaDependiente(pareja) {
  var lugar = $("input:radio[name=lugar]:checked").val(),
    amt = null;
  var colonia = "",
    tipoVia = "",
  ...
  var actividadLaboral = $("#ambito").val(),
    rfc = null,
    funciones = "",
    sector = "",
    nivel = "",
  ...
  $.ajax({
    ...
    data: JSON.stringify({
      ...
      curp: curp,
      rfc: $("#rfc").val(),
      fecha_nacimiento: document
        .getElementById("fecNac")
        .value.replace(/^(\d{4})-(\d{2})-(\d{2})$/g, "$3/$2/$1"),
      no_identificacion: "",
...
function insertarPrestamos() {
  var inmueble = "",
    ...
    colonia_domicilio = "",
    tipo_via_domicilio = "",
    nombre_via_domicilio = "",
    no_exterior_domicilio = "",
    no_interior_domicilio = "",
    ciudad_domicilio_extranjero = "",
    entidad_domicilio_extranjero = "",
    vehiculo = "",
    tipo_vehiculo = "",
    marca_vehiculo = "",
    modelo_vehiculo = "",
    anio_vehiculo = "",
    no_serie_vehiculo = "",
    pais_registro_vehiculo = "",
    entidad_registro_vehiculo;
  var tipoRelacion = $("#tipoRelacion").val();
  var fisicaPro = false,
    moralPro = false;
...
function insertarEmpresasSociedades() {
  var pais = $("input:radio[name=registro]:checked").val(),
  ...
  if ($("input:radio[name=declarado]:checked").val() == "Declarante") {
    ...
    $("input:radio[name=declarado]:checked").val() == "Dependiente económico"
  ) {
    declarante = false;
    pareja = false;
...
function insertarInstituciones() {
  var pais = $("input:radio[name=registro]:checked").val(),
    estado = $("#entidadFed").val(),
    declarante = "",
    pareja = "",
    dependiente_economico = "",
    tipoInstitucion = $("#tipoInstitucion").val();
  var monto = 0;
  if ($("input:radio[name=remuneracion]:checked").val() == "true") {
    monto = $("#monto").val();
  }
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        institucionesAplica(true);
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById(
            "semaforoInstituciones"
          ).style.color = "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
...
function insertarApoyosBeneficios() {
  var beneficiario = $("#beneficiario").val(),
    tipoBeneficio = $("#tipoApoyo").val(),
    especie = "";
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        beneficiosPublicosAplica(true);
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById(
            "semaforoBeneficiosPublicos"
          ).style.color = "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        representacionAplica(true);
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById(
            "semaforoRepresentacion"
          ).style.color = "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
...
function insertarClientesPrincipales() {
  var pais = $("input:radio[name=registro]:checked").val(),
    estado = $("#entidadFed").val(),
    declarante = "",
    pareja = "",
  ...
  $.ajax({
    ...
    data: JSON.stringify({
      tipo_declaracion: tipoDeclaracion,
      actividad_lucrativa: $(
        "input:radio[name=actividadLucrativa]:checked"
      ).val(),
      declarante: declarante,
      pareja: pareja,
      dependiente_economico: dependiente_economico,
...
function insertarBeneficiosPrivados() {
  var tipoBeneficio = $("#tipoApoyo").val(),
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        beneficiosPrivadosAplica(true);
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById(
            "semaforoBeneficiosPrivados"
          ).style.color = "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      if (data.msg == "Sesión Expirada") {
        ...
        fideicomisosAplica(true);
        if (confirm("¿Agregar otro registro?")) {
          window.parent.document.getElementById(
            "semaforoFideicomisos"
          ).style.color = "#1EE164";
          window.location.href = "#tituloD";
          location.reload();
        } else {
