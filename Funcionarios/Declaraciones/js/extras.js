...
function declarante() {
  if (
    $("input:radio[name=declarado]:checked").val() == "Declarante" ||
    $("#beneficiario").val() == "DECLARANTE"
  ) {
  ...
  if (
    $("input:radio[name=repr]:checked").val() == "fisica" ||
    $("input:radio[name=client]:checked").val() == "fisica" ||
    $("input:radio[name=otorgante]:checked").val() == "fisica"
  ) {
...
function mostrarTerceros() {
  ...
  if (
    $("#titular").val() == "DECLARANTE" ||
    $("#titular").val() == "DECLARANTE EN COPROPIEDAD CON TERCEROS"
  ) {
...
function form8() {
  if (tipoDeclaracion == 1) {
    ...
    $("#campo14").text(
      "B.- Ingresos mensual neto de la pareja y/o dependientes económicos"
    );
    $("#campo15").text(
      "C.- Total de ingresos mensuales netos percibidos por el declarante, pareja y/o dependientes económicos"
    );
  } else if (tipoDeclaracion == 2) {
    $("#enajenacion").show();
    $("#tipoEnajenacion").show();
    $("#campo1").text(
      "I.- Remuneración anual neta del declarante por su cargo público (Por concepto de sueldos, honorarios, compensaciones, bonos y otras prestaciones)"
    );
    $("#campo13").text("A.- Ingresos anual neto del declarante");
    $("#campo14").text(
      "B.- Ingresos anual neto de la pareja y/o dependientes económicos"
    );
    $("#campo15").text(
      "C.- Total de ingresos anuales netos percibidos por el declarante, pareja y/o dependientes económicos"
    );
  } else if (tipoDeclaracion == 3) {
    $("#enajenacion").show();
    $("#tipoEnajenacion").show();
    $("#campo1").text(
      "I.- Remuneración neta del año en curso a la fecha de  conclusión del empleo, cargo o comisión del declarante por su cargo público (Por concepto de sueldos, honorarios, compensaciones, bonos y otras prestaciones)"
    );
    $("#campo13").text(
      "A.- Ingresos del declarante del año en curso a la fecha de conclusión del empleo, cargo o comisón"
    );
    $("#campo14").text(
      "B.- Ingresos del año en curso a la fecha de conclusión del empleo, cargo o comisón de la pareja y/o dependientes económicos"
    );
    $("#campo15").text(
      "C.- Total de ingresos netos del año en curso a la fecha de conclusión del empleo, cargo o comisón persibidos por el declarante, pareja y/o dependientes económicos"
    );
  }
}
    ...
    .done(function (datos) {
      if (datos.status) {
        ...
        if (
          ...
          document.getElementById("semaforoFideicomisos").style.color =
            "#1EE164";
        } else {
          form = 21;
        }
        if (
          ...
          document.getElementById("semaforoBeneficiosPrivados").style.color =
            "#1EE164";
        } else {
          form = 20;
        }
        ...
        if (
          ...
          document.getElementById("semaforoRepresentacion").style.color =
            "#1EE164";
        } else {
          form = 18;
        }
        if (
          ...
          document.getElementById("semaforoBeneficiosPublicos").style.color =
            "#1EE164";
        } else {
          form = 17;
        }
        if (
          ...
          document.getElementById("semaforoInstituciones").style.color =
            "#1EE164";
        } else {
          form = 16;
        }
        ...
        if (sessionStorage.getItem("declaracion_completa") == "true") {
          if (
            ...
            document.getElementById("semaforoPrestamos").style.color =
              "#1EE164";
          } else {
            form = 14;
          }
          ...
          if (
            ...
            document.getElementById("semaforoInversiones").style.color =
              "#1EE164";
          } else {
            form = 12;
          }
          ...
          if (
            ...
            document.getElementById("semaforoInmuebles").style.color =
              "#1EE164";
          } else {
            form = 9;
          }
        ...
        if (
          ...
          document.getElementById("semaforoAnteriorServidor").style.color =
            "#1EE164";
        } else {
          if (tipoDeclaracion != 2) {
            form = 8;
        ...
        if (sessionStorage.getItem("declaracion_completa") == "true") {
          if (datos.result.data.dependientes || !objeto.aplica_dependiente) {
            document.getElementById("semaforoDependiente").style.color =
              "#1EE164";
          } else {
            form = 6;
          }
        ...
        if (datos.result.data.exp_laboral || !objeto.aplica_exp_laboral) {
          document.getElementById("semaforoExperiencia").style.color =
            "#1EE164";
        } else {
          form = 4;
        }
...
function sigForm() {
  ...
  switch (form) {
    ...
    case 13:
      window.location.href = "#tituloD";
      document.getElementById("vista").src =
        "../1-Dec_Patrimonial/14-adeudos.html";
    ...
    case 22:
      ...
      alert(
        "Recuerde enviar antes su Constancia de Declaración Fiscal para poder concluir."
      );
      break;
    default:
      window.location.href = "#tituloD";
